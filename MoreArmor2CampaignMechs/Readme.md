...
## Easy Copy mechs
All custom mech from the MechBay are saved inside settings_cloud.sav as plain txt. Just have to search and copy Locations and Inventory. File is located one folder up from saved games
